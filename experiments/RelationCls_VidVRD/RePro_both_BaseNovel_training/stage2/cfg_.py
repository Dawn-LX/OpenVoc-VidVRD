model_pred_cfg = dict(
    ...
    n_prompt_groups = 6,
    giou_th = -0.3,
    prompter_ckpt_path = "experiments/RelationCls_VidVRD/RePro_both_BaseNovel_training/stage1/model_bsz32_best_mAP.pth",
...
train_cfg = dict(
    batch_size          = 2, # 2 for cpu debug, originally is 32 for GPU
    total_epoch         = 50,
    initial_lr          = 1e-4,
    lr_decay            = 0.2,
