...
model_traj_cfg = dict(
    ...
    num_base = 25,
    num_novel = 10,
    text_emb_path = "/home/gkf/project/ALPRO/extract_features_output/vidvrd_ObjTextEmbeddings.npy",
    loss_factor = dict(
        classification = 1.0,
        distillation = 5.0,
    )
...
train_dataset_cfg = dict(
    ...
    traj_cls_split_info_path = "/home/gkf/project/VidVRD-OpenVoc/configs/VidVRD_class_spilt_info.json",
    pred_cls_split_info_path = "configs/VidVRD_pred_class_spilt_info_v2.json",
